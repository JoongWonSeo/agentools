...
class ChatCompletionUsageTracker:
    ...
    def track_usage(self, completion: ChatCompletion) -> ChatCompletion:
        ...
        print(f"Cost for {model}: ${self.calculate_cost(model, usage):0.2f}, Total: ${self.calculate_cost(model, self.usage_per_model[model]):0.2f}")
    ...
    def calculate_cost(cls, model: str, usage: CompletionUsage) -> float:
        ...
        return usage.completion_tokens/1000 * cls.MODEL_PRICING[model]['completion_tokens'] + \
