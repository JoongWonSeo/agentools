...
# from agentools.messages.realtime import RealtimeHistory
...
# from ..messages import MessageHistory, RealtimeHistory, msg, Message, Content
# from .utils import atuple, format_event
# from .core import Assistant


# class RealtimeGPT(Assistant):
#     """ChatGPT Realtime with default model and toolkit"""
...
#         self,
#         session: Session,
#         messages: RealtimeHistory | None = None,
#     ):
#         self.session = session
#         """Current session state, either pending or as confirmed from server"""
#         self.messages = messages or RealtimeHistory()
#         """Current message history, same format as normal chat completion"""

#         assert self.session.model, "Model must be specified in the session"

#         # ========== Realtime Connection ========== #
#         client: AsyncOpenAI = get_default_async_client(model=self.session.model)
#         self.connection_manager: AsyncRealtimeConnectionManager = (
#             client.beta.realtime.connect(model=self.session.model)
#         )
...
#         # (re)establish configured initial settings
#         await self.connection.session.update(session=self.session)
...
#             **openai_kwargs: Additional arguments to pass to the OpenAI API
#         """
#         messages: MessageHistory = self.messages
